...
public class Address {
    ...
    private final boolean exists; // address may not exist i.e., in the case of mobile homes
    ...
    /**
     * address may not exist for certain properties i.e., mobile homes
     * hence this method returns if the address exists
     *
     * @return boolean representing if address exists
     */
    ...
    public String toString() {
        if (exists) {
            return this.streetNumber
                    ...
                    + ", " + this.countryName;
        } else return "Does not exist / Subject to change";
    }
